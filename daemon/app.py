...
def run_postprocessing(
    ...
    try:
        ...
        # Constants
        output_json_file = "../data/benchmark_results.json"
        ...
        if benchmarks_data:
            ...
            with open("../data/daedalus_sat_solver_summary.csv", "w", newline="") as f:
...
# ---------------------------------------------------------------------------
def get_teensy_port():
    return "/dev/cu.usbmodem158960201"
