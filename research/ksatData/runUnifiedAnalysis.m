...
function generateReport(data, existingParams, existingMetrics, optimalPoints, insights, targetPassRate)
    ...
    fprintf(fid, '\nRECOMMENDATIONS\n');
    fprintf(fid, '---------------\n');
    fprintf(fid, '1. Use the balanced configuration for general operation\n');
    fprintf(fid, '2. Load optimal settings: run >> load_optimal_config\n');
    fprintf(fid, '3. Review the master dashboard for comprehensive analysis\n');
    fprintf(fid, '4. Consider parameter thresholds when tuning\n');
